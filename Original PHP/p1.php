...
echo '<center><br>';
		...
		$pozostalo = $uzytkownik['bendicion1_time'] - time();
...
if($uzytkownik['bendicion1_time'] > 0) {
...
mysql_query("update gracze set rubies = rubies - 14, bendicion1_time = '".$koniec."', bendicion1_type = 1 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion1_time = '".$koniec."', bendicion1_type = 2 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion1_time = '".$koniec."', bendicion1_type = 3 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion1_time = '".$koniec."', bendicion1_type = 4 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion1_time = '".$koniec."', bendicion1_type = 5 where gracz = ".$uzytkownik['gracz']);
