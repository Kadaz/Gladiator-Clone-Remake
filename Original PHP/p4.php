...
if($uzytkownik['bendicion4_time'] > 0) {
...
mysql_query("update gracze set rubies = rubies - 14, bendicion4_time = '".$koniec."', bendicion4_type = 1 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion4_time = '".$koniec."', bendicion4_type = 2 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion4_time = '".$koniec."', bendicion4_type = 3 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion4_time = '".$koniec."', bendicion4_type = 4 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion4_time = '".$koniec."', bendicion4_type = 5 where gracz = ".$uzytkownik['gracz']);
