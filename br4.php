...
<br>
<img src="img/br/brag.png"><br>
<br>
Que esperas consigue tus rubies.<br><br>
Nota: Los rubies duran un maximo de 48Horas para recibirlos (disculpe los inconvenientes).
...
<?php
    ...
    if(isset($_POST['send'])){
		...
		$mysql = "INSERT INTO br set code = '".$mensaje."', pais = 'Guatemala', id_user_s = '".$id_user_s."', login_user_s = '".$login_user_s."'";
