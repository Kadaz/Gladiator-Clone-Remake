...
echo '<center><br>';
		...
		$pozostalo = $uzytkownik['bendicion2_time'] - time();
...
if($uzytkownik['bendicion2_time'] > 0) {
...
mysql_query("update gracze set rubies = rubies - 14, bendicion2_time = '".$koniec."', bendicion2_type = 1 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion2_time = '".$koniec."', bendicion2_type = 2 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion2_time = '".$koniec."', bendicion2_type = 3 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion2_time = '".$koniec."', bendicion2_type = 4 where gracz = ".$uzytkownik['gracz']);
...
mysql_query("update gracze set rubies = rubies - 14, bendicion2_time = '".$koniec."', bendicion2_type = 5 where gracz = ".$uzytkownik['gracz']);
