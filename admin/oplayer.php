...
?>
<h><center><p><b>¡This profile is of <?php echo $oplayer['login']; ?>!</b></p>
<div style="width:200px;text-align:center">
			<center><div style="background-image:url(img/faces/spieler_name_bg.png);width:168px;height:60px;overflow:hidden"> <span style=color:#FFFF00><font size=4><b><?php echo $oplayer['login']; ?></span></b></font> <align="absmiddle" border="0"></div></center>
			<img src="img/faces/<?php echo "".$oplayer['avatar'].""; ?>.gif" align="absmiddle" border="0">
...
if(mysql_num_rows($sql) != 0) {
    ...
    while($przedmiot = mysql_fetch_array($sql)){
        ...
        <tr align='center'>
            ...
            <td><center>".$przedmiot['cena_sprzedaj']."</td>
